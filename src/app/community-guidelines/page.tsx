...
export default function CommunityGuidelinesPage() {
  return <div className="shell page narrow-page legal-page"><div className="page-intro"><p className="eyebrow">CỘNG ĐỒNG</p><h1>Quy tắc RokViet Hub</h1><p>Không gian trao đổi thực tế, tôn trọng và hữu ích cho người chơi Rise of Kingdoms.</p></div>
